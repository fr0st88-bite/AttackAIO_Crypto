...
class BrainWallet:
    ...
    def base58(address_hex):
        alphabet = '123456789ABCDEFGHJJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz'
        b58_string = ''
        leadingmzeros = len(address_hex) - len(address_hex.lstrip('0'))
...
def MmDrza():
    ...
    for i in range(0, len(mylist)):
        ...
        if bal1 != ifer or bal2 != ifer or bal3 != ifer or bal4 != ifer or bal5 != ifer or bal6 != ifer:
            w += 1
            save_found("Bitcoin", addr1, bal1, passphrase, private_key)
