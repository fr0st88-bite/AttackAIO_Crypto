...
def MmDrza():
    ...
    for i in range(len(mylist)):
        ...
        url_n = f"https://dash2.trezor.io/address/{addr}"
        se = HTMLSession()
        nmp = se.get(url_n)
        ...
        if bal != ifxbtc:
            ...
            console.print(f"[red1][Scan:[cyan]{count}[/cyan] - [green1]Found:[/green1][cyan]{w}[/cyan]][ DASH ADDR:[white] {addr} [/white]] [ Value:[cyan]{bal}[/cyan] ] # Passphrase:[white] {passphrase}[/white][/red1]")
            continue
